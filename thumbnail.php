...
$cacheFolder = $_SERVER['DOCUMENT_ROOT'].'/cache/'; # path to your cache folder, must be writeable by web server
...
$cmd = $path_to_convert." ".$imagePath." -resize ".$resize." -size ".$w."x".$h." xc:".(isset($opts['canvas-color'])?$opts['canvas-color']:"#FFF")." +swap -gravity center -composite -quality ".$quality." ".$newPath;
endif;
